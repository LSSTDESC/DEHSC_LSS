...
Surveys of the large scale structure play an increasingly important role in our quest to understand the Universe and its constituents. With ever increasing precision it is particularly important to keep systematic effects under control -- it is expected that the Stage IV photometric dark energy experiments will be limited by systematic effects rather than statistical precision afforded by the survey.

As the surveys becomes deep, the number density of sources on the sky increases and selection effects associated with blending becomes more pronounced: sources measured in crowded fields with be necessary undergone different selection effects compared to those in underdensities directly giving a signal-dependent systematic effect. Their fluxes will be measured with different errors, leading to subtle biases in determination of photometric redshift distributions. 
