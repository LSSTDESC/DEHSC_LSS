 ...
 \subsection{Magnification}\label{ssec:results.magnification}
    ...
    \begin{figure}
      \begin{center}
        ...
        \caption{\todo{UPDATE WITH FULLY CONVERGED RESULTS} Comparison of our fiducial HOD constraints to those obtained when varying the magnification amplitude. The inner (outer) contour shows the $68 \%$ c.l. ($95 \%$ c.l.).}
  ...
  \subsection{Joint cosmology and HOD constraints}\label{ssec:results.cosmo}
    ...
    \begin{figure}
      \begin{center}
        ...
        \caption{\todo{UPDATE WITH FULLY CONVERGED RESULTS} Constraints on cosmological parameters obtained from a joint fit to all auto- and cross power spectra. The inner (outer) contour shows the $68 \%$ c.l. ($95 \%$ c.l.).}
