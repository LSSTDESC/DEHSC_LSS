...
auto & $\sfrac{26.8}{25}$ & $3.32\substack{+2.03 \\ -1.79}$ & $12.32 \pm 0.14$ & $6.49\substack{+2.80 \\ -2.47}$ & $13.72\substack{+0.20 \\ -0.19}$  & - & - & - \\
G cov & $\sfrac{98.4}{80}$ & $3.59\substack{+1.52 \\ -1.44}$ & $12.34 \pm 0.14$ & $6.89\substack{+1.96 \\ -1.89}$ & $13.74\substack{+0.19 \\ -0.20}$ & - & - & - \\
G+SSC cov & $\sfrac{97.8}{80}$ & $3.28\substack{+1.57 \\ -1.51}$ & $12.31\substack{+0.14 \\ -0.13}$ & $6.46\substack{+2.15 \\ -2.10}$ & $13.71 \pm 0.20$ & - & - & - \\
no $z_{w, i}$ & $\sfrac{97.8}{84}$ & $2.69\substack{+1.17 \\ -1.08}$ & $12.24 \pm 0.09$ & $5.74\substack{+1.95 \\ -1.66}$ & $13.62\substack{+0.14 \\ -0.13}$ & - & - & - \\
no $z_{w, i}, \Delta z_{i}$ & $\sfrac{102.2}{88}$ & $3.23 \pm 0.76$ & $12.27 \pm 0.06$ & $6.43\substack{+1.17 \\ -1.18}$ & $13.65 \pm 0.10$ & - & - & - \\
no $z_{w, i}$, HSC $\Delta z_{i}$ prior & - & - & - & - & - & - & - & - \\
bins=0, 1, 2 & - & - & - & - & - & -& -  & - \\
bins=1, 2, 3 & - & - & - & - & - & - & - & - \\
pz=\texttt{Ephor\_AB} & $\sfrac{99.8}{80}$ & $2.96\substack{+1.22 \\ -1.12}$ & $12.45 \pm 0.11$ & $6.07\substack{+1.66 \\ -1.54}$ & $13.90 \pm 0.16$ & - & - & - \\
pz=\texttt{Ephor} & $\sfrac{107.6}{80}$ & $3.18\substack{+1.24 \\ -1.27}$ & $12.43 \pm 0.12$ & $6.34\substack{+1.75 \\ -1.77}$ & $13.87 \pm 0.17$ & - & - & - \\
pz=\texttt{DEmP} & $\sfrac{106.4}{80}$ & $2.90\substack{+1.35 \\ -1.33}$ & $12.37 \pm 0.12$ & $5.95\substack{+1.87 \\ -1.83}$ & $13.78 \pm 0.17$ & - & - & - \\
pz=\texttt{FRANKEN-Z} & $\sfrac{98.6}{80}$ & $2.66\substack{+1.17 \\ -1.08}$ & $12.45 \pm 0.11$ & $5.63\substack{+1.61 \\ -1.51}$ & $13.88 \pm 0.16$ & - & - & - \\
pz=\texttt{Ephor\_AB}, no $z_{w, i}$ & - & - & - & - & - & - & - & - \\
pz=\texttt{Ephor}, no $z_{w, i}$ & - & - & - & - & - & - & - & - \\
pz=\texttt{DEmP}, no $z_{w, i}$ & - & - & - & - & - & -& -  & - \\
pz=\texttt{FRANKEN-Z}, no $z_{w, i}$ & - & - & - & - & - & - & - & - \\
fiducial magn. & $\sfrac{83.4}{79}$ & $3.53\substack{+1.88 \\ -1.71}$ & $12.33 \pm 0.15$ & $6.63\substack{+2.50 \\ -2.23}$ & $13.72\substack{+0.20 \\ -0.21}$  & - & - & - \\
fit magn., auto+cross & $\sfrac{83.8}{79}$ & $3.34\substack{+1.85 \\ -1.74}$ & $12.32 \pm 0.15$ & $6.45\substack{+2.47 \\ -2.31}$ & $13.72\substack{+0.20 \\ -0.21}$  & $0.99\substack{+0.37 \\ -0.36}$ & - & - \\
fit magn., auto & $\sfrac{26.8}{25}$ & $3.16\substack{+1.80 \\ -1.63}$ & $12.31\substack{+0.14 \\ -0.13}$ & $6.34\substack{+2.52 \\ -2.29}$ & $13.72\substack{+0.20 \\ -0.19}$  & $-0.25\substack{+1.34 \\ -1.27}$ & - & - \\
fit cosmo & $\sfrac{93.0}{78}$ & $3.37\substack{+1.73 \\ -1.66}$ & $12.19\substack{+0.20 \\ -0.17}$ & $6.55\substack{+2.33 \\ -2.30}$ & $13.58\substack{+0.31 \\ -0.30}$  & - & $-0.228\substack{+0.022 \\ -0.023}$ & $0.837\substack{+0.193 \\ -0.211}$ \\
 \hline \hline
\end{tabular}
\end{center}
\end{sidewaystable}
...
In order to test the impact of photometric redshift uncertainties on our fiducial HOD constraints, we compare them to those obtained when separately fixing $z_{w, i} = 0$ and $z_{w, i} = 0, \Delta z_{i} = 0$. The results are shown in Fig.~\ref{fig:constraints-hod-pz-shifts-pz-widths-vs-pz-shifts-vs-no-pz-shifts}. 
...
\caption{Comparison of the constraints on magnification amplitude obtained from auto power spectra alone to those obtained from auto and cross power spectra.}
