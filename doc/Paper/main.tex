...
The paper is structured as follows.  In Section \ref{sec:data}, we discuss the HSC-SSP data and how we process it in order to generate a set of galaxy over-density maps together with maps of potential systematics. In Section \ref{sec:methods}, we go through the methodology employed in our analysis and in Section \ref{sec:results}, we present results alongside numerous tests. We discuss and conclude in Section \ref{sec:discussion}.
...
fit cosmo & $\sfrac{84.4}{78}$ $(0.12)$ & $0.0867\substack{+2.69 \\ -2.50}$ & $11.81\substack{+0.27 \\ -0.23}$ & $1.70\substack{+3.39 \\ -3.16}$ & $12.97\substack{+0.36 \\ -0.35}$  & - & $0.237 \pm 0.025$ & $0.806\substack{+0.148 \\ -0.145}$ \\
 \hline \hline
\end{tabular}
\end{center}
\end{sidewaystable}
