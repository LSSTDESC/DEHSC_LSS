...
\subfigure[Dependence of the mean halo mass $\bar{M}_{\mathrm{halo}}$ on redshift as predicted from our best-fit HOD model.]{\includegraphics[width=0.3\textwidth]{figures/M_halo_mPk=HOD_fix=alpha-fc-sigmaM_HOD=zevol_fit=pz-shifts+prior=0p2-pz-widths+prior=0p2_fit=auto+cross_cosmo=const_cov=G+NG+SSC-LINBIAS_HOD-param=zfid_clfit=HOD-zevol_M1p-pr.pdf}} 
\caption{...} 
