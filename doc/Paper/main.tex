...
\begin{table*}
\caption{Summary of the cosmological models considered in this work.} \label{tab:models}
\begin{center}
\begin{tabular}{cccccccc}
\hline\hline 
Analysis variant & $M_{\mathrm{min}, p}$ & $M_{\mathrm{min}}$ & $M_{1, p}$ & $M_{1}$ & $A_{\mu}$ & $\Omega_{c}$ & $\sigma_{8}$ \\ \hline      
fiducial & - & - & - & - & - & - & - \\
auto & - & - & - & - & - & - & - \\
G cov & - & - & - & - & - & - & - \\
G+SSC cov & - & - & - & - & - & - & - \\
