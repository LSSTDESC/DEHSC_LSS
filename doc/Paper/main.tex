...
The paper is structured as follows.  In Section \ref{sec:data} we discuss the HSC-SSP data and how we process it in order to generate a set of galaxy over-density maps together with maps of potential systematics. In Section \ref{sec:methods} we go through the methodology employed in our analysis of the data and in Section \ref{sec:results} we present results together with numerous tests. We discuss and conclude in Section \ref{sec:discussion}.
    ...
    \begin{table*}
      ...
      \begin{center}
        \begin{tabular}{cccc}
          ...
          $M_{\mathrm{min}}$ & flat $\in [0., \,17.]$ & $11.89\substack{+0.24 \\ -0.25}$ & $11.76$ \\ 
          $M_{\mathrm{min}, p}$ & flat $\in [-10., \,10.]$ & $-0.0606\substack{+2.50 \\ -2.40}$ & $-2.95$ \\
          $M_{0}$ & flat $\in [0., \,15.]$ & $5.85\substack{+4.03 \\ -4.05}$ & $5.58$ \\
          $M_{0, p}$ & flat $\in [-5., \,10.]$ & $2.33\substack{+5.12 \\ -4.93}$ & $-0.925$ \\
          $M_{1}$ & flat $\in [0., \,15.]$ & $13.09\substack{+0.24 \\ -0.25}$ & $12.96$ \\ 
          $M_{1, p}$ & flat $\in [-10., \,15.]$ & $1.49\substack{+3.21 \\ -3.08}$ & $-2.07$ \\
          $\Delta z_{0}$ & flat $\in [-0.2, \,0.2]$ & $0.000147\substack{+0.102 \\ -0.096}$ & $-0.0456$ \\
          $\Delta z_{1}$ & flat $\in [-0.2, \,0.2]$ & $-0.0128\substack{+0.103 \\ -0.096}$ & $-0.0923$ \\
          $\Delta z_{2}$ & flat $\in [-0.2, \,0.2]$ & $-0.00170\substack{+0.109 \\ -0.104}$ & $-0.103$ \\
          $\Delta z_{3}$ & flat $\in [-0.2, \,0.2]$ & $0.0148\substack{+0.109 \\ -0.106}$ & $-0.0727$ \\
          $z_{w, 0}$ & flat $\in [-0.2, \,0.2]$ & $-0.0300\substack{+0.130 \\ -0.119}$ & $-0.177$ \\
          $z_{w, 1}$ & flat $\in [-0.2, \,0.2]$ & $0.000837\substack{+0.0780 \\ -0.0785}$ & $-0.0991$ \\
          $z_{w, 2}$ & flat $\in [-0.2, \,0.2]$ & $0.0342\substack{+0.0825 \\ -0.0794}$ & $0.0243$ \\
          $z_{w, 3}$ & flat $\in [-0.2, \,0.2]$ & $0.0355\substack{+0.122 \\ -0.138}$ & $0.151$ \\ \\
          $A_{\mu}$ & flat $\in [-3., \,3.]$ & $ - $ & $ - $ \\
...
\begin{figure}
\begin{center}
\includegraphics[width=0.95\textwidth]{figures/Cls-data-vs-best-fit_mPk=HOD_fix=alpha-fc-sigmaM_HOD=zevol_fit=pz-shifts+prior=0p2-pz-widths+prior=0p2_fit=auto+cross_cosmo=const_cov=G+NG+SSC-LINBIAS_HOD-param=zfid_clfit=HOD-zevol_no-mag-vs-mag_M1p-pr.pdf}
\caption{\todo{UPDATE} Measured auto- and cross power spectra considered in our analysis. The solid lines show the theoretical predictions obtained from the best-fit model parameters obtained in a joint fit to both auto- and cross power spectra not allowing for magnification while the dashed lines show the theoretical predictions obtained allowing for a free magnification amplitude $A_{\mu}$.}
...
\begin{sidewaystable}
\caption{\todo{UPDATE last 4 entries} Parameter constraints and best-fit $\chi^{2}$ values obtained for all considered analysis variants. The number of degrees of freedom $\nu$ is estimated according to $\nu = N_{\mathrm{data}}-N_{\mathrm{param}}$. In the second column of the table, the values in brackets denote the $p$-values corresponding to the observed best-fit $\chi^{2}$. The uncertainties denote the $68 \%$ c.l..} \label{tab:constraints_robustness}
\begin{center}
\begin{tabular}{ccccccccc}
\hline\hline 
Analysis variant & $\sfrac{\chi^{2}}{\nu}$ & $M_{\mathrm{min}, p}$ & $M_{\mathrm{min}}$ & $M_{1, p}$ & $M_{1}$ & $A_{\mu}$ & $\Omega_{c}$ & $\sigma_{8}$ \\ \hline \Tstrut       
fiducial & $\sfrac{82.0}{80}$ $(0.42)$ & $-0.0606\substack{+2.50 \\ -2.40}$ & $11.89\substack{+0.24 \\ -0.25}$ & $1.49\substack{+3.21 \\ -3.08}$ & $13.09\substack{+0.29 \\ -0.30}$ & - & - & - \\
auto & $\sfrac{18.0}{25}$ $(0.84)$ & $-0.665\substack{2.66 \\ -2.72}$ & $11.78\substack{0.31 \\ -0.28}$ & $0.705\substack{+3.29 \\ -3.30}$ & $12.95\substack{+0.37 \\ -0.33}$  & - & - & - \\
G cov & $\sfrac{83.4}{80}$ $(0.38)$ & $-0.0602\substack{+2.71 \\ -2.16}$ & $11.91\substack{+0.20 \\ -0.21}$ & $1.46\substack{+3.36 \\ -2.78}$ & $13.10\substack{+0.25 \\ -0.26}$ & - & - & - \\
G+SSC cov & $\sfrac{83.0}{80}$ $(0.39)$ & $-0.370\substack{+2.38 \\ -2.18}$ & $11.87\substack{+0.24 \\ -0.25}$ & $1.12\substack{+3.05 \\ -2.75}$ & $13.06\substack{+0.29 \\ -0.30}$ & - & - & - \\
no $z_{w, i}$ & $\sfrac{83.6}{84}$ $(0.49)$ & $0.770\substack{+0.679 \\ -0.891}$ & $11.86\substack{+0.13 \\ -0.14}$ & $0.494\substack{+0.929 \\ -1.21}$ & $13.05\substack{+0.18 \\ -0.20}$ & - & - & - \\
no $z_{w, i}, \Delta z_{i}$ & $\sfrac{90.2}{88}$ $(0.42)$ & $-1.16\substack{+0.632 \\ -0.845}$ & $11.75 \pm 0.14$ & $-0.130\substack{+0.687 \\ -1.01}$ & $12.89 \pm 0.17$ & - & - & - \\
bins = 0, 1, 2 & $\sfrac{41.0}{43}$ $(0.56)$ & $-0.408\substack{+2.35 \\ -2.46}$ & $11.84 \pm 0.25$ & $0.585\substack{+2.84 \\ -2.99}$ & $13.03\substack{+0.31 \\ -0.30}$ & - & - & - \\
bins = 1, 2, 3 & $\sfrac{42.6}{46}$ $(0.62)$ & $1.22\substack{+3.27 \\ -3.22}$ & $11.94\substack{+0.34 \\ -0.39}$ & $3.49\substack{+4.16 \\ -4.08}$ & $13.19\substack{+0.42 \\ -0.39}$ & - & - & - \\
pz = \texttt{Ephor\_AB} & $\sfrac{89.6}{80}$ $(0.22)$ & $0.396\substack{+2.2 \\ -2.1}$ & $12.12\substack{+0.20 \\ -0.19}$ & $2.02\substack{+3.07 \\ -2.88}$ & $13.37\substack{+0.27 \\ -0.26}$ & - & - & - \\
pz = \texttt{Ephor} & $\sfrac{102.0}{80}$ $(0.049)$ & $1.16\substack{+2.02 \\ -2.09}$ & $12.14\substack{+0.18 \\ -0.17}$ & $3.01\substack{+2.75 \\ -2.87}$ & $13.39\substack{+0.23 \\ -0.22}$ & - & - & - \\
pz = \texttt{DEmP} & $\sfrac{100.8}{80}$ $(0.058)$ & $0.493\substack{+1.93 \\ -1.97}$ & $12.03 \pm 0.20$ & $2.15\substack{+2.64 \\ -2.67}$ & $13.25 \pm 0.27$ & - & - & - \\
pz = \texttt{FRANKEN-Z} & $\sfrac{87.2}{80}$ $(0.27)$ & $0.387\substack{+1.99 \\ -1.96}$ & $12.13 \pm 0.18$ & $2.00\substack{+2.79 \\ -2.74}$ & $13.38 \pm 0.24$ & - & - & - \\
 ...
 \subsection{Magnification}\label{ssec:results.magnification}
    ...
    \begin{figure}
      \begin{center}
        ...
        \caption{\todo{UPDATE} Comparison of our fiducial HOD constraints to those obtained when varying the magnification amplitude. The inner (outer) contour shows the $68 \%$ c.l. ($95 \%$ c.l.).}
  ...
  \subsection{Joint cosmology and HOD constraints}\label{ssec:results.cosmo}
    ...
    \begin{figure}
      \begin{center}
        ...
        \caption{\todo{UPDATE} Constraints on cosmological parameters obtained from a joint fit to all auto- and cross power spectra. The inner (outer) contour shows the $68 \%$ c.l. ($95 \%$ c.l.).}
