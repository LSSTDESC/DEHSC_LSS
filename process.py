...
print("Will lose %d objects to depth, S/N and stars"%(np.sum(~(sel_maglim*sel_gals*sel_fluxcut*sel_blended))))
cat.remove_rows(~(sel_maglim*sel_gals*sel_fluxcut*sel_blended))
